...
namespace NHaml4.Tests.Walkers.CodeDom
{
    ...
    public class HamlNodeCodeWalker_Tests
    {
        ...
        public void Walk_ValidNodeWithNoChildren_CallsAppendCodeSnippetMethodWithFalse()
        {
            ...
            var node = new HamlNodeCode(new HamlLine(codeSnippet, NHaml4.Parser.HamlRuleEnum.Code, "", -1));
        ...
        {
            var node = new HamlNodeCode(new HamlLine("1+1", NHaml4.Parser.HamlRuleEnum.Code, "", -1));
        ...
        public void Walk_ConditionalWithChildNode_RendersChildNode()
        {
            ...
            var node = new HamlNodeCode(new HamlLine("if (true)", NHaml4.Parser.HamlRuleEnum.Code, "", -1));
        ...
        {
            var node = new HamlNodeCode(new HamlLine("1+1", NHaml4.Parser.HamlRuleEnum.Code, "", -1));
            var childNode = new HamlNodeCode(new HamlLine("1+1", NHaml4.Parser.HamlRuleEnum.Code, "", -1));

	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 28:
				...
				else if (ch == 'U') {apx = 0; AddCh(); goto case 112;}
				else if (ch == 'u') {apx = 0; AddCh(); goto case 113;}
				else if (ch == 'L') {apx = 0; AddCh(); goto case 114;}
				else if (ch == 'l') {apx = 0; AddCh(); goto case 115;}
				else {
					tlen -= apx;
			...
			case 44:
				...
				else if (ch == 92) {AddCh(); goto case 120;}
				else {t.kind = noSym; break;}
			case 45:
			...
			case 61:
				...
				else if (ch == 92) {AddCh(); goto case 123;}
				else {t.kind = noSym; break;}
			case 62:
			...
			case 76:
				...
				else if (ch == '"') {AddCh(); goto case 126;}
				else {t.kind = noSym; break;}
			case 77:
				{t.kind = 5; break;}
			case 78:
			...
			case 101:
				{t.kind = 118; break;}
			case 102:
				if (ch >= '0' && ch <= '9') {apx = 0; AddCh(); goto case 102;}
				else if (ch == 'U') {apx = 0; AddCh(); goto case 112;}
				else if (ch == 'u') {apx = 0; AddCh(); goto case 113;}
				else if (ch == 'L') {apx = 0; AddCh(); goto case 114;}
				else if (ch == 'l') {apx = 0; AddCh(); goto case 115;}
			...
			case 137:
				...
				else if (ch == '=') {AddCh(); goto case 132;}

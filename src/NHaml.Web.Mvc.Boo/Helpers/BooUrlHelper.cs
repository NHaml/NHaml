...
namespace NHaml.Web.Mvc.Boo.Helpers
{
  ...
  {
    public BooUrlHelper( RequestContext requestContext ) : base( requestContext )
    {
    }

    public BooUrlHelper( RequestContext requestContext, RouteCollection routeCollection ) : base( requestContext, routeCollection )
    {
    }
